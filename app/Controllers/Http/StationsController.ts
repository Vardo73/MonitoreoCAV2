...
export default class StationsController {
    ...
    public async showFWOP({view}:HttpContextContract){
        ...
        return view.render('admin/stationFWOP',{stations,models,relacion,sponsors,stationSponsors});
    }

    public async storeFWOP({request}:HttpContextContract){
        try {
            let sponsors= request.input('sponsors');
            const station=await Station.create({
                slug:request.input('slug'),
    ...
    public async editFWOP({request}:HttpContextContract){
        try {
    ...
    public async historicsFWOP({view,request}:HttpContextContract){
        try {
            ...
            return view.render('airelimpio/historicsFwop',{stations,slug,data});
        } catch (error) {  
            console.log(error)
        }
    }
